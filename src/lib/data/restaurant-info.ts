...
export const aboutContent = {
  ...
  story: 'რესტორანი "სანადიმო" არის ქართული სამზარეულოსა და ტრადიციული სუფრის ადგილი თანამედროვე გარემოში. ჩვენთან შეგიძლიათ დაგეგმოთ როგორც ჩვეულებრივი სადილი, ისე ოჯახის ან მეგობრების პატარა ზეიმი. ჩვენ ვამზადებთ კლასიკურ ქართულ კერძებს: ხინკალს, ხაჭაპურს, სხვადასხვა ტიპის მწვადს, ცხელ და ცივ საჭმელებს და სალათებს. პროდუქტები მაქსიმალურად ადგილობრივია და კერძები მზადდება ყოველდღიურად, შეკვეთიდან.',
};
